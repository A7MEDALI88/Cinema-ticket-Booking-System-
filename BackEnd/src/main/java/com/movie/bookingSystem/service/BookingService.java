...
public class BookingService {
    ...
    public void cancelBooking(String userEmail, Long bookingId) {
        ...
        // << استخدام findByIdForUpdate لقفل صف الفيلم
        Movie movie = movieRepository.findByIdForUpdate(booking.getMovie().getId())
                .orElseThrow(() -> new RuntimeException("Movie not found"));
    ...
    private BookingResponse mapToResponse(Booking booking, Ticket ticket) {
        ...
        response.setMovieLocation(booking.getMovie().getHall().getLocation());
